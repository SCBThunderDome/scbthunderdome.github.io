/* ============================================================
   ...
   ------------------------------------------------------------
   SEASON.nextAdvance used to be free text: "Thursday, August 13th
   — 11:00 PM EDT". That reads well and is impossible to compute
   ...
   authored:
     ...
     nextAdvanceAt  "2026-08-13T23:00:00-04:00"   the real value
     nextAdvance    "Thursday, August 13th — 11:00 PM EDT"  derived
...
(function (root, factory) {
  ...
  /* House style for the generated sentence: an em dash with spaces
     around it, matching every deadline this league has ever posted.
     It's a constant rather than inline so the one place that decides
     how a deadline reads is obvious — change it here and the site,
     the advance announcement and the nudge all follow. */
  const SEPARATOR = " — ";
  ...
  /* ------------------------------------------------------------
     ...
     ------------------------------------------------------------
     "2026-08-13" + "23:00" means 11 PM in New York, whatever the
  ...
  /* ------------------------------------------------------------
     ...
     whether the string carries its own offset:
       ...
       2026-08-13T23:00:00-04:00   absolute. Trusted as written —
                                   this is what we store, so
                                   re-reading our own field is
                                   lossless even if the DST rules
                                   change under us.
       2026-08-13 23:00           wall clock. Interpreted as
       2026-08-13T23:00           Eastern, per the note up top.
  ...
  /* ------------------------------------------------------------
     ...
     nudge all render this and none of them changed.
       ...
       Thursday, August 13th — 11:00 PM EDT
