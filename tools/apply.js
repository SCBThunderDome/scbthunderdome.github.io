...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------ */
/* Which leagues each action may touch. The lists are kept separate
   (rather than collapsed to one) so a league can be made scores-only
   later by dropping it from ADVANCE_LEAGUES alone. */
...
/* ------------------------------------------------------------
   ...
   The name is checked against the roster, so
