...
/* ============================================================
   ...
   time: a coach who finds out at 11 PM that they're playing someone
   ...
   The admin page can also move the deadline WITHOUT advancing (the
   "Change the deadline" box), and that path writes the same pair —
   so pushing Tuesday to Thursday moves this post to Thursday too,
